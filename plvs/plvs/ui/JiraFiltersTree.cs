...
namespace Atlassian.plvs.ui {
    public sealed class JiraFiltersTree : TreeView {
        ...
        public bool NodeWithServerSelected {
            get { return SelectedNode != null && SelectedNode is TreeNodeWithServer; }
        }
        ...
        public TreeNodeWithServer findGroupNode(JiraServer server, Type type) {
        ...
        public JiraServer getCurrentlySelectedServer() {
            TreeNodeWithServer node = SelectedNode as TreeNodeWithServer;
        ...
        public void addCustomFilter(TreeNodeWithServer node) {
            if (node == null) {
                return;
            }
